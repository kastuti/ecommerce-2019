...
<head>
  ...
  <link href="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/css/sb-admin.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/vendor/chart.js/Chart.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/js/sb-admin.min.js"></script>

  <!-- Demo scripts for this page-->
  <script src="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/js/demo/chart-area-demo.js"></script>
  <script src="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/js/demo/chart-bar-demo.js"></script>
  <script src="http://localhost/codeigniter3/assets/theme/startbootstrap-sb-admin-gh-pages/js/demo/chart-pie-demo.js"></script>
